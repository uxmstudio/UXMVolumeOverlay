...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of UXMVolumeOverlay."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/UXMVolumeOverlay"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Chris Anderson" => "hi@chrisanderson.io" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/UXMVolumeOverlay.git", :tag => s.version.to_s }
